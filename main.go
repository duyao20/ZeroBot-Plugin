...
func init() {
	...
	url := flag.String("u", "ws://124.221.138.7:6708", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "duyao", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "ATRI", "atri", "duyao", "アトリ"),
